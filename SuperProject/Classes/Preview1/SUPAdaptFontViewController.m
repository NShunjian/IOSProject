...
@interface SUPAdaptFontViewController ()

/** <#digest#> */
@property (nonatomic, strong) NSMutableArray<SUPParagraph *> *paragraphs;

@end

@implementation SUPAdaptFontViewController
...
{
    SUPAdaptFontCell *cell = [SUPAdaptFontCell adaptFontCellWithTableView:tableView];
...
- (NSMutableArray<SUPParagraph *> *)paragraphs
{
    if(!_paragraphs)
    {
        ...
        [datas enumerateObjectsUsingBlock:^(NSString  *_Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            SUPParagraph *pa = [[SUPParagraph alloc] init];
            pa.words = obj;
