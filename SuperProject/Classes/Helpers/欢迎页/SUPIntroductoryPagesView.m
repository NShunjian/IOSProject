...
@interface SUPIntroductoryPagesView ()<UIScrollViewDelegate>
/** <#digest#> */
...
@implementation SUPIntroductoryPagesView

+ (instancetype)pagesViewWithFrame:(CGRect)frame images:(NSArray<NSString *> *)images
{
    SUPIntroductoryPagesView *pagesView = [[self alloc] initWithFrame:frame];
