...
/** 根文件夹 */
static NSString * const MJDownloadRootDir = @"com_github_shunjian_www_mjdownload";
...
- (void)didReceiveResponse:(NSHTTPURLResponse *)response
{
    ...
    if (!self.totalBytesExpectedToWrite) {
        ...
        SUPLog(@"_totalFileSizes  ==   %@",_totalFileSizes);
    }
...
+ (void)initialize
{
    ...
    SUPLog(@"_totalFileSizesFile== %@",_totalFileSizesFile);
