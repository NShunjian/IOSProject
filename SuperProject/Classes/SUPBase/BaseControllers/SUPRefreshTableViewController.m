//
//  SUPRefreshTableViewController.m
//  SuperProject
//
...
@interface SUPRefreshTableViewController ()

@end

@implementation SUPRefreshTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    SUPWeakSelf(self);
    self.tableView.mj_header = [SUPNormalRefreshHeader headerWithRefreshingBlock:^{
    ...
    self.tableView.mj_footer = [SUPAutoRefreshFooter footerWithRefreshingBlock:^{
