...
@interface SUPDragTableViewController ()<SUPVerticalFlowLayoutDelegate>
...
@implementation SUPDragTableViewController

// 可以更改列数
const NSInteger SUPDragTableViewControllerCols_ = 3;
...
{
    return SUPDragTableViewControllerCols_;
}
/**
 *  列间距, 默认10
 */
