...
@implementation SUPExpandHeader
...
+ (instancetype)expandWithScrollView:(UIScrollView*)scrollView expandView:(UIView*)expandView{
    SUPExpandHeader *expandHeader = [SUPExpandHeader new];
...
- (void)expandWithScrollView:(UIScrollView*)scrollView expandView:(UIView*)expandView{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(removeObserver) name:SUPTableViewControllerDeallocNotification object:_scrollView.viewController];
}
...
- (void)removeObserver
{
    if (_scrollView) {
        ...
        [[NSNotificationCenter defaultCenter] removeObserver:self name:SUPTableViewControllerDeallocNotification object:_scrollView.viewController];
