...
@interface SUPListExpendHeaderView ()
...
@implementation SUPListExpendHeaderView

+ (instancetype)headerViewWithTableView:(UITableView *)tableView
{
    SUPListExpendHeaderView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:NSStringFromClass(self)];
